  ...
  <div>
    <el-container class="customContainer">
      <el-header
        ...
        style="height: 80px !important; color: white"
      >
        <div>
      ...
      <!-- 分割线 -->
      <el-divider class="dividing_line1"></el-divider>

      <el-container>
        <el-aside width="180px">
          <el-menu
            router
            default-active="/teacherPage"
            ...
            text-color="#fff"
          >
            <el-menu-item index="/History"><i class="el-icon-s-order"></i>待定待定</el-menu-item>
            <el-menu-item index="/Reservation/AllReservationPage">
              <template slot="title">
                <i class="el-icon-bell"></i>
                <span>考试管理</span>
              </template>
              <el-menu-item index="/manageBank">创建考试</el-menu-item>
              <el-menu-item index="/addBank">试卷管理</el-menu-item>
              <el-menu-item index="/addBank">分析考试</el-menu-item>
            </el-menu-item>

            <!-- <el-menu-item index="/NewTable1"><i class="el-icon-eleme"></i>题库管理</el-menu-item> -->

            <el-submenu index="02" background-color="#165e48" color="#333">
              <template slot="title">
                <i class="el-icon-s-data"></i>
                <span>题库管理</span>
              </template>
              <el-menu-item index="/manageBank">整理题库</el-menu-item>
              <el-menu-item index="/addBank">扩充题库</el-menu-item>
            </el-submenu>

            <el-menu-item index="/VIP200"
              ><i class="el-icon-s-custom"></i>待定待定</el-menu-item
            >
            <el-menu-item index="/test1"
              ><i class="el-icon-info"></i>测试测试</el-menu-item
            >
          </el-menu>
        </el-aside>
...
export default {
  ...
  rules: {
    ...
    againPwd: [{ required: true, message: "请输入新密码", trigger: "blur" }],
  },
  ...
  methods: {
    ...
    showper() {
      ...
      this.$axios
        .get("/api/Employee/getEmployeeInfobyAttr", {
          params: {
            attribute: "staff_id",
    ...
    perPicture() {
      ...
      this.$axios
        .get("/api/Employee/getEmployeePict", {
          params: {
